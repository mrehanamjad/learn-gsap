  ...
  useGSAP(() => {
    ...
    boxes.forEach(box => {
      gsap.to(box,{
        ...
        scrollTrigger:{
          trigger:box,
          start:'bottom bottom', // when bottom of element = bottom of view port/screen
          end:'top 20%', // when top of element = 20% of viewport
          scrub:true, // makes the enimation smooth
        },
        ease:'power1.inOut'
      })
    })
